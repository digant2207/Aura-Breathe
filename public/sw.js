...
// Fetch: Cache-first for assets and Google Fonts, Network-first with cache fallback for navigations
self.addEventListener('fetch', (event) => {
  ...
  // If requesting HTML page / navigation
  ...
  // Assets (JS, CSS, SVGs, Fonts, Images)
  event.respondWith(
